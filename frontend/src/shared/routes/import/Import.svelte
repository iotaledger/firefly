...
{:else}
    <OnboardingLayout allowBack>
        <div slot="leftpane__content">
            ...
            <Button icon="biometric" classes="w-full mb-5" secondary onClick={() => goto('import-from-seed')}>
                {locale('views.import.action_1')}
            </Button>
            <Button icon="pin" classes="w-full mb-8" secondary onClick={() => goto('import-from-security-phrase')}>
                {locale('views.import.action_2')}
            </Button>
        </div>
