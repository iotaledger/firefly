...
- All code should be well formatted and linted, passing both locally and in our [linting continuous integration](https://github.com/iotaledger/firefly/blob/develop/.github/workflows/ci.lint.yml) workflow

- All code should be well tested, passing unit and integration tests both locally and in our [testing continuous integration](https://github.com/iotaledger/firefly/blob/develop/.github/workflows/ci.test.yml) workflow
