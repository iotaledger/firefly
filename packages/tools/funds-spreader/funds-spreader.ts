...
import { IFaucetRequestData, IFaucetResponseData, IFundsSpreaderParameters } from './interfaces'

const BASE_FILE_PATH = './funds-spreader/temp'
...
const FUND_SPREADERS_PARAMETERS: IFundsSpreaderParameters[] = [
...
async function spreadFunds(parameters: IFundsSpreaderParameters): Promise<void> {
