<script lang="typescript">
    ...
    let selectedAccount = account || accounts.map((acc) => ({ ...acc, label: acc.name }))[0]
        ...
        <div class="w-full">
            ...
            <div>
                ...
                <div class="w-full mb-8 block">
                    ...
                    <Address autoGenerated loading={loadingAddress} address={selectedAccount.address} {locale} />
                </div>
                <Button secondary disabled={loadingAddress} classes="w-full mb-4" onClick={generateNewAddress}>
