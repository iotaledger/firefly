...
{#if $selectedAccount}
    {#if $mobile}
        <div
            ...
            class="{$mobile ? 'account-color ' : ' dark:bg-gray-900'} wallet-wrapper w-full h-full flex flex-col bg-gray-50"
        >
            <div class="flex flex-auto flex-col">
                ...
                <div class="flex flex-1">
                    <DashboardPane classes="{$mobile && 'rounded-b-none'} w-full rounded-tl-s rounded-tr-s">
                        <AccountHistory
