...
<div class='h-full flex flex-col justify-between'>
    <div class="flex justify-center items-center flex-col text-center">
        ...
        <Text type="p" classes="text-gray-700 mb-5 font-normal text-14" overrideColor>{localize('views.governance.info.description')}</Text>
    </div>
    <Link classes="mr-5 text-13 text-gray-800 border border-solid border-gray-300 rounded-xl py-4 pl-6 flex justify-between bg-gray-50 hover:bg-blue-100"
