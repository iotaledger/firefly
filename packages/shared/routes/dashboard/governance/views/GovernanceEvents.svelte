...
<Button classes="w-1/4 mt-auto" onClick={handleButtonClick} disabled={!event}><Text type="h5" overrideColor classes="text-white">{localize('views.governance.events.button')}</Text></Button>
