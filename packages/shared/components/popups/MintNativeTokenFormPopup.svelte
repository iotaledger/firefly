...
<div class="space-y-6">
    ...
    <div class="space-y-4 max-h-100 scrollable-y flex-1">
        ...
        <optional-inputs class="flex flex-row flex-wrap gap-2">
            ...
            />
            <OptionalInput bind:value={description} label={localize('popups.mintNativeTokenForm.inputs.description')} />
            <OptionalInput bind:value={url} label={localize('popups.mintNativeTokenForm.inputs.url')} />
            <OptionalInput bind:value={logoUrl} label={localize('popups.mintNativeTokenForm.inputs.logoUrl')} />
        </optional-inputs>
        {#if error}
