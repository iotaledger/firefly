...
<aside
    class="flex flex-col justify-center items-center bg-white dark:bg-gray-800 h-screen relative w-20 px-5 pb-10 pt-9 border-solid border-r border-gray-100 dark:border-gray-800">
