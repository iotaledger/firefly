...
export const EXPLORER_URLS: Readonly<{ [key in NetworkId]?: string }> = {
    ...
    [NetworkId.IotaTestnet]: 'https://explorer.shimmer.network/testnet', // TODO: update when testnet is available
    [NetworkId.Shimmer]: 'https://explorer.shimmer.network/shimmer',
    [NetworkId.ShimmerTestnet]: 'https://explorer.shimmer.network/testnet',
}
