...
const INITIAL_APP_SETTINGS: IAppSettings = {
    deepLinking: false,
    language: 'en',
    theme: 'light',
    darkMode: false,
 ...
 */
export const appSettings = persistent<IAppSettings>('appSettings', INITIAL_APP_SETTINGS)
 ...
 */
export const initAppSettings = writable<Readonly<Partial<IAppSettings>>>(INITIAL_APP_SETTINGS)
