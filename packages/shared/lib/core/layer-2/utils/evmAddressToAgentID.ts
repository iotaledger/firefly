...
import { AccountAddress } from '@iota/sdk'
...
export function evmAddressToAgentID(evmStoreAccount: string, accountAddress: string): Uint8Array {
    ...
    const accountAddressInBytes = Converter.hexToBytes(AddressConverter.addressToBech32(new AccountAddress(accountAddress)))
