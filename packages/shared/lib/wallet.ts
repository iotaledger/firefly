...
import type { Account, Account as BaseAccount, AccountToCreate, Balance, SyncedAccount, CallGlowPayload } from 'shared/lib/typings/account'
...
export const api: {
    ...
    callGlow(pld: CallGlowPayload, callbacks: { onSuccess: (response: Event<NodeInfo>) => void, onError: (err: ErrorEventPayload) => void })
