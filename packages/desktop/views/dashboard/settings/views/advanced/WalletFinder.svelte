<script lang="ts">
    ...
    function onWalletFinderClick(): void {
        openOverlay({ id: PopupId.WalletFinder })
    }
</script>
...
<div class="flex flex-row items-center">
    <Button size={ButtonSize.Medium} inlineStyle="min-width: 156px;" onClick={onWalletFinderClick}>
